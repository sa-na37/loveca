# Static Evidence PL!HS-pb1-014#A02

- audit_id: PL!HS-pb1-014#A02
- cardnumber: PL!HS-pb1-014
- cardname: 安養寺姫芽
- effect_text: <BODY> / このメンバーの正面のエリアにいる相手のメンバーのコストが、このメンバーのコストより高いかぎり、 / <桃> / を得る。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "このメンバーの正面のエリアにいる相手のメンバーのコストが、このメンバーのコストより高いかぎり、<桃>を得る。",
      "cost_op": null,
      "effect_op": null,
      "raw": "このメンバーの正面のエリアにいる相手のメンバーのコストが、このメンバーのコストより高いかぎり、\n<桃>\nを得る。"
    }
  ]
}
```
