# Static Evidence PL!S-bp7-016#A01

- audit_id: PL!S-bp7-016#A01
- cardnumber: PL!S-bp7-016
- cardname: 国木田花丸
- effect_text: <BODY> / 自分のステージにメンバーが3人以上いるかぎり、 / <赤> / <緑> / <青> / を得る。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "自分のステージにメンバーが3人以上いるかぎり、<赤><緑><青>を得る。",
      "cost_op": null,
      "effect_op": null,
      "raw": "自分のステージにメンバーが3人以上いるかぎり、\n<赤>\n<緑>\n<青>\nを得る。"
    }
  ]
}
```
