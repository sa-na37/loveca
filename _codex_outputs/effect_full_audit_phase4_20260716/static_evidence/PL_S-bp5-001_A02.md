# Static Evidence PL!S-bp5-001#A02

- audit_id: PL!S-bp5-001#A02
- cardnumber: PL!S-bp5-001
- cardname: 高海千歌
- effect_text: <BODY> / 能力を持たないメンバーを自分の手札から登場させるためのコストは1減る。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "能力を持たないメンバーを自分の手札から登場させるためのコストは1減る。",
      "cost_op": null,
      "effect_op": null,
      "raw": "能力を持たないメンバーを自分の手札から登場させるためのコストは1減る。"
    }
  ]
}
```
