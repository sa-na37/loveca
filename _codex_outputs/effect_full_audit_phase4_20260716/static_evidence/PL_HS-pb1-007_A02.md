# Static Evidence PL!HS-pb1-007#A02

- audit_id: PL!HS-pb1-007#A02
- cardnumber: PL!HS-pb1-007
- cardname: セラス 柳田 リリエンフェルト
- effect_text: <BODY> / 自分のステージにメンバーがちょうど2人おり、かつ相手のステージにメンバーが3人以上いるかぎり、 / <紫> / を得る。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "自分のステージにメンバーがちょうど2人おり、かつ相手のステージにメンバーが3人以上いるかぎり、<紫>を得る。",
      "cost_op": null,
      "effect_op": null,
      "raw": "自分のステージにメンバーがちょうど2人おり、かつ相手のステージにメンバーが3人以上いるかぎり、\n<紫>\nを得る。"
    }
  ]
}
```
