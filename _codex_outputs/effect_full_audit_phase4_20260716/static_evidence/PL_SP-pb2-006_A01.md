# Static Evidence PL!SP-pb2-006#A01

- audit_id: PL!SP-pb2-006#A01
- cardnumber: PL!SP-pb2-006
- cardname: 桜小路きな子
- effect_text: <BODY> / このメンバーの下にある『Liella!』のメンバーカード1枚につき、このメンバーのコストを+1する。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "このメンバーの下にある『Liella!』のメンバーカード1枚につき、このメンバーのコストを+1する。",
      "cost_op": null,
      "effect_op": null,
      "raw": "このメンバーの下にある『Liella!』のメンバーカード1枚につき、このメンバーのコストを+1する。"
    }
  ]
}
```
