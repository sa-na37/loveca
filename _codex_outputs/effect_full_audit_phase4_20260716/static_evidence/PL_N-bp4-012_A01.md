# Static Evidence PL!N-bp4-012#A01

- audit_id: PL!N-bp4-012#A01
- cardnumber: PL!N-bp4-012
- cardname: 鐘嵐珠
- effect_text: <BODY> / 相手の成功ライブカード置き場にあるカードのスコアの合計が6以上であるかぎり、ライブの合計スコアを+1する。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "相手の成功ライブカード置き場にあるカードのスコアの合計が6以上であるかぎり、ライブの合計スコアを+1する。",
      "cost_op": null,
      "effect_op": null,
      "raw": "相手の成功ライブカード置き場にあるカードのスコアの合計が6以上であるかぎり、ライブの合計スコアを+1する。"
    }
  ]
}
```
