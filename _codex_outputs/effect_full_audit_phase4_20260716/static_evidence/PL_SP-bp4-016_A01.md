# Static Evidence PL!SP-bp4-016#A01

- audit_id: PL!SP-bp4-016#A01
- cardnumber: PL!SP-bp4-016
- cardname: 葉月恋
- effect_text: <BODY> / カードの効果で自分のエネルギー置き場にエネルギーカードが置かれるたび、ライブ終了時まで、<紫> / を得る。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "カードの効果で自分のエネルギー置き場にエネルギーカードが置かれるたび、ライブ終了時まで、<紫>を得る。",
      "cost_op": null,
      "effect_op": null,
      "raw": "カードの効果で自分のエネルギー置き場にエネルギーカードが置かれるたび、ライブ終了時まで、<紫>\nを得る。"
    }
  ]
}
```
