...
# Blocked success-zone real-card route PL!HS-bp2-020
...
export LLOCG_DEBUG_EFFECT_CARD='BLOCKED_NO_REAL_CARD_REFERENCE'
...
# BLOCKED_NO_REAL_CARD_REFERENCE: no real DB card was found for this success-zone group/unit alias condition.
python3 ./run_llocg_ui_web.py --host 127.0.0.1 --port 8800 --debug
