...
# Group alias green test for PL!HS-bp5-018, control=False
...
export LLOCG_START_HAND='PL!HS-bp2-005,LL-bp1-001'
export LLOCG_START_HAND_SIZE='0'
export LLOCG_START_GREEN='PL!HS-bp5-018'
...
export LLOCG_START_DECK_EXACT='LL-bp1-001,LL-bp5-001,LL-bp2-001'
