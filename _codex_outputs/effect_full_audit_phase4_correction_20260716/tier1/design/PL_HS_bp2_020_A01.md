...
- required_zone: all zones for alias, or stage for member continuous effects
...
- expected_state_change: computed value changes without pending
...
- manual_steps: Place/check the card in relevant zones and inspect computed state/helper evidence; no pending expected.
