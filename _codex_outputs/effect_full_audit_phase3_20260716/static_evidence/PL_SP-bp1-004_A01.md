# Static Evidence PL!SP-bp1-004#A01

- audit_id: PL!SP-bp1-004#A01
- cardnumber: PL!SP-bp1-004
- cardname: 平安名すみれ
- effect_text: <BODY> / ステージのセンターエリアにいる場合、<(ブレード)><(ブレード)><(ブレード)><(ブレード)><(ブレード)> / を得る。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "ステージのセンターエリアにいる場合、<(ブレード)><(ブレード)><(ブレード)><(ブレード)><(ブレード)>を得る。",
      "cost_op": null,
      "effect_op": null,
      "raw": "ステージのセンターエリアにいる場合、<(ブレード)><(ブレード)><(ブレード)><(ブレード)><(ブレード)>\nを得る。"
    }
  ]
}
```
