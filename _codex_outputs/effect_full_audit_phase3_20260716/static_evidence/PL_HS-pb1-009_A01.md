# Static Evidence PL!HS-pb1-009#A01

- audit_id: PL!HS-pb1-009#A01
- cardnumber: PL!HS-pb1-009
- cardname: 日野下花帆
- effect_text: <BODY> / 自分のステージに『蓮ノ空』のメンバーが登場するたび、ライブ終了時まで、<(ブレード)><(ブレード)> / を得る。
...
```json
{
  "ability_type": "自動",
  "trigger": "BODY",
  "conditions": "センター;ターン2回",
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "自分のステージに『蓮ノ空』のメンバーが登場するたび、ライブ終了時まで、<(ブレード)><(ブレード)>を得る。",
      "cost_op": null,
      "effect_op": null,
      "raw": "自分のステージに『蓮ノ空』のメンバーが登場するたび、ライブ終了時まで、<(ブレード)><(ブレード)>\nを得る。"
    }
  ]
}
```
