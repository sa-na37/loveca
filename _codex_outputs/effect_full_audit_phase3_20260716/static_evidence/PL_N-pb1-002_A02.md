# Static Evidence PL!N-pb1-002#A02

- audit_id: PL!N-pb1-002#A02
- cardnumber: PL!N-pb1-002
- cardname: 中須かすみ
- effect_text: <BODY> / このメンバーの下にエネルギーカードが2枚以上置かれているかぎり、ライブの合計スコアを+1する。
...
- `llocg_ui/engine.py:13696:                elif 'このメンバーの下にエネルギーカードが' in blob and '枚以上置かれているかぎり' in blob and 'ライブの合計スコアを+' in blob:`
- `llocg_ui/engine.py:13697:                    m = re.search(r'このメンバーの下にエネルギーカードが(\d+)枚以上置かれているかぎり、ライブの合計スコアを\+(\d+)する', blob)`
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "このメンバーの下にエネルギーカードが2枚以上置かれているかぎり、ライブの合計スコアを+1する。",
      "cost_op": null,
      "effect_op": null,
      "raw": "このメンバーの下にエネルギーカードが2枚以上置かれているかぎり、ライブの合計スコアを+1する。"
    }
  ]
}
```
