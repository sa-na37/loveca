# Static Evidence PL!N-PR-027#A01

- audit_id: PL!N-PR-027#A01
- cardnumber: PL!N-PR-027
- cardname: 朝香果林
- effect_text: <BODY> / 自分と相手のステージにメンバーが合計6人いるかぎり、 / <赤> / <青> / を得る。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "自分と相手のステージにメンバーが合計6人いるかぎり、<赤><青>を得る。",
      "cost_op": null,
      "effect_op": null,
      "raw": "自分と相手のステージにメンバーが合計6人いるかぎり、\n<赤>\n<青>\nを得る。"
    }
  ]
}
```
