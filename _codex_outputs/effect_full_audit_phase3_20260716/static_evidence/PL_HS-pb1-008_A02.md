# Static Evidence PL!HS-pb1-008#A02

- audit_id: PL!HS-pb1-008#A02
- cardnumber: PL!HS-pb1-008
- cardname: 桂城泉
- effect_text: <BODY> / 相手のステージにいるメンバーはアクティブフェイズにアクティブにならない。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "相手のステージにいるメンバーはアクティブフェイズにアクティブにならない。",
      "cost_op": null,
      "effect_op": null,
      "raw": "相手のステージにいるメンバーはアクティブフェイズにアクティブにならない。"
    }
  ]
}
```
