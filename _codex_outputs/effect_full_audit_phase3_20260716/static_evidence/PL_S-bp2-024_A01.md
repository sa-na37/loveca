# Static Evidence PL!S-bp2-024#A01

- audit_id: PL!S-bp2-024#A01
- cardnumber: PL!S-bp2-024
- cardname: 君のこころは輝いてるかい？
- effect_text: <BODY> / このカードは成功ライブカード置き場に置くことができない。
  ...
  "clauses": [
    {
      "optional": false,
      "cost_template": "",
      "effect_template": "このカードは成功ライブカード置き場に置くことができない。",
      "cost_op": null,
      "effect_op": null,
      "raw": "このカードは成功ライブカード置き場に置くことができない。"
    }
  ]
}
```
