...
# PL!SP-bp2-013 optional execute
...
export LLOCG_DEBUG_EFFECT_CARD='PL!SP-bp2-013'
export LLOCG_START_HAND='PL!SP-bp2-013'
export LLOCG_START_GREEN='PL!SP-bp4-024,PL!SP-bp1-001'
export LLOCG_START_DECK_EXACT='PL!SP-bp4-004,PL!SP-bp4-007,PL!SP-pb1-001'
python3 ./run_llocg_ui_web.py --host 127.0.0.1 --port 8798 --debug
