...
.matCmdBar{position:absolute;right:1.6%;bottom:2.2%;display:flex;flex-direction:column !important;gap:10px;z-index:120;pointer-events:auto}
.matInfo{font-size:14px;line-height:1.2;background:rgba(255,255,255,.85);border:1px solid rgba(0,0,0,.18);border-radius:10px;padding:8px 10px;min-width:160px;text-align:right}
.matCmdBar button{font-size:20px;padding:10px 16px;border-radius:10px;border:1px solid rgba(0,0,0,.25);background:#fff;cursor:pointer}
...
#matInfoBox{height:44px; display:flex; align-items:center; justify-content:center;}
#matInfo{font-size:18px; font-weight:800; white-space:nowrap;}
#phasePill{position:absolute; left:50%; bottom:14px; transform:translateX(-50%);
  background:rgba(0,0,0,0.65); color:#fff; padding:8px 14px; border-radius:14px;
  font-size:22px; font-weight:800; letter-spacing:0.5px; z-index:20;}
#matZoneOverlay{position:absolute; left:50%; top:55%; transform:translate(-50%,-50%);
  width:900px; max-width:90%; height:360px; max-height:50%;
  background:rgba(255,255,255,0.86); border-radius:16px; box-shadow:0 10px 28px rgba(0,0,0,0.25);
  padding:16px 16px 12px 16px; display:none; z-index:30; overflow:hidden;}
...
#matZoneOverlay .grid{display:flex; flex-wrap:wrap; gap:10px; overflow:auto; height:300px; padding-right:6px;}
